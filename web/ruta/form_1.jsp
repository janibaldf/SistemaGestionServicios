    ...
    <div class="col">
          <div class="card">
            ...
            <div class="card-body">
                  ...
                  <s:form action="ruta/nuevo" method="post" cssClass="form-inline">
                    <div class="row">
                    <div class="form-group ">
                        <label  class="col-md-3 col-form-label" for="codigo">Codigo</label>
                        <s:textfield type="text" cssClass="form-control" name="codigo" placeholder="0"/>
                    </div>
                    <div class="form-group">
                        <label  class="col-md-3 col-form-label" for="placa">Placa</label>
                        <s:textfield type="text" cssClass="form-control" name="placa" placeholder="C-ABC123"/>
                    </div>
                      <div class="form-group">
                        <label  class="col-md-4 col-form-label" for="ruta">Autorizacion</label>
                        <s:textfield type="text" cssClass="form-control" name="ruta" placeholder="555"/>
                    </div>
                    <br/>
                    </div>
                     <div class="row">
                         <div class="form-group">
                        <label  class="col-md-3 col-form-label" for="exampleInputEmail2">Email</label>
